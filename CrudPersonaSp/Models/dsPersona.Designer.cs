...
namespace CrudPersonaSp.Models {
    ...
    public partial class dsPersona : global::System.Data.DataSet {
        ...
        public partial class PersonaDataTable : global::System.Data.TypedTableBase<PersonaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonaRow AddPersonaRow(int idPersona, string nombre, string direccion, byte[] imagen, System.DateTime nacimiento, string telefono, string email) {
        ...
        public partial class PersonaRow : global::System.Data.DataRow {
            ...
            public byte[] imagen {
                get {
                    try {
                        return ((byte[])(this[this.tablePersona.imagenColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'imagen\' in table \'Persona\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePersona.imagenColumn] = value;
                }
            }
            ...
            public bool IsimagenNull() {
                return this.IsNull(this.tablePersona.imagenColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetimagenNull() {
                this[this.tablePersona.imagenColumn] = global::System.Convert.DBNull;
            }
...
namespace CrudPersonaSp.Models.dsPersonaTableAdapters {
    ...
    public partial class PersonaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Persona] WHERE (([idPersona] = @Original_idPersona) AND ([nombre] = @Original_nombre) AND ([direccion] = @Original_direccion) AND ((@IsNull_nacimiento = 1 AND [nacimiento] IS NULL) OR ([nacimiento] = @Original_nacimiento)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Persona] ([idPersona], [nombre], [direccion], [imagen], [nacimiento], [telefono], [email]) VALUES (@idPersona, @nombre, @direccion, @imagen, @nacimiento, @telefono, @email);
SELECT idPersona, nombre, direccion, imagen, nacimiento, telefono, email FROM Persona WHERE (idPersona = @idPersona)";
...
SELECT idPersona, nombre, direccion, imagen, nacimiento, telefono, email FROM Persona WHERE (idPersona = @idPersona)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["dbTestPersonaConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idPersona, nombre, direccion, imagen, nacimiento, telefono, email FROM dbo" +
                ".Persona";
        ...
        public virtual int Delete(int Original_idPersona, string Original_nombre, string Original_direccion, global::System.Nullable<global::System.DateTime> Original_nacimiento, string Original_telefono, string Original_email) {
        ...
        public virtual int Insert(int idPersona, string nombre, string direccion, byte[] imagen, global::System.Nullable<global::System.DateTime> nacimiento, string telefono, string email) {
            ...
            if ((nacimiento.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((System.DateTime)(nacimiento.Value));
            }
            else {
        ...
        public virtual int Update(int idPersona, string nombre, string direccion, byte[] imagen, global::System.Nullable<global::System.DateTime> nacimiento, string telefono, string email, int Original_idPersona, string Original_nombre, string Original_direccion, global::System.Nullable<global::System.DateTime> Original_nacimiento, string Original_telefono, string Original_email) {
            ...
            if ((nacimiento.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(nacimiento.Value));
            }
            else {
            ...
            if ((Original_nacimiento.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((System.DateTime)(Original_nacimiento.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string direccion, byte[] imagen, global::System.Nullable<global::System.DateTime> nacimiento, string telefono, string email, int Original_idPersona, string Original_nombre, string Original_direccion, global::System.Nullable<global::System.DateTime> Original_nacimiento, string Original_telefono, string Original_email) {
            return this.Update(Original_idPersona, nombre, direccion, imagen, nacimiento, telefono, email, Original_idPersona, Original_nombre, Original_direccion, Original_nacimiento, Original_telefono, Original_email);
        }
    }
